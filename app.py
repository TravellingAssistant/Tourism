...
def submituser_feedback():
    ...
    if data:
        ...
        try:
            ...
            send_email(
                recipient='vijaykumargoli2003@gmail.com',
...
def send_email(
    recipient='vijaykumargoli2003@gmail.com',  # Default recipient
...
def predict():
    from_date = request.form['From_Date']  # Expected format: YYYY-MM-DD
    to_date = request.form['To_Date']  # Expected format: YYYY-MM-DD
    ...
    # Convert dates from YYYY-MM-DD format to DD-MM-YYYY format
    from_date_obj = datetime.strptime(from_date, "%Y-%m-%d")
    to_date_obj = datetime.strptime(to_date, "%Y-%m-%d")

    formatted_from_date = from_date_obj.strftime("%d-%m-%Y")
    formatted_to_date = to_date_obj.strftime("%d-%m-%Y")
    # print("From Place:", formatted_from_date)
    # print("To Place:", formatted_to_date)
